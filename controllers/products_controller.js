...
export const fetchProductById = async (req, res)=>{
    try {
        ...
        const product = await Product.findById(productId).populate({path: 'ratings', populate: {path: 'user'}});
...
export const deleteProduct = async (req, res)=>{
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Could not delete product and associated ratings : "+err.message
        })
    }
